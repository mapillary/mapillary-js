...
export { IExtremePointTagOptions } from "../component/tag/interfaces/IExtremePointTagOptions";
export { IOutlineTagOptions } from "../component/tag/interfaces/IOutlineTagOptions";
export { ISpotTagOptions } from "../component/tag/interfaces/ISpotTagOptions";
