...
- Github differential - [v3.1.0...v4.0.0-beta.5](https://github.com/mapillary/mapillary-js/compare/v3.1.0...v4.0.0-beta.5)
...
- `type` - Event type
- `target` - Instance that emitted the event Additional properties are provided per event type.
...
The complete API functionality, including ents, contracts, and providers, has been replaced. See the [v4 API reference](/api/modules/api) and examples for info about the new implementation of data providers, geometry providers, contracts, and entities.
