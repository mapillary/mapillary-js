...
To start using MapillaryJS with data from the [Mapillary](https://www.mapillary.com) platform, you need an app token. When [extending MapillaryJS](/docs/extension) to render your own data, no app token is needed.
