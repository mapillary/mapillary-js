...
To start using MapillaryJS with data from the [Mapillary](https://www.mapillary.com) platform, you need to have an [account](https://www.mapillary.com/app/?login=true). After signing in, you need [register an application](https://www.mapillary.com/dashboard/developers) to get a [client access token](https://mapillary.com/developer/api-documentation).
...
Now you are ready to start exploring the [guide to main concepts](/docs/main/guides).
