...
To start using MapillaryJS with data from the [Mapillary](https://www.mapillary.com) platform, you need an access token. When [extending MapillaryJS](/docs/extension/extend) to provide your own data, no access token is needed.
  ...
  class ViewerComponent extends React.Component {
    ...
    componentDidMount() {
      this.viewer = new Viewer({
        apiClient: this.props.accessToken,
