...
describe("EdgeCalculator.computeTurnEdges", () => {
    ...
    it("should have a turn left edge", () => {
        ...
        expect(turnEdge.data.direction).toBe(EdgeConstants.EdgeDirection.TURN_LEFT);
    });
    ...
    it("should have a turn right edge", () => {
        ...
        expect(turnEdge.to).toBe(potentialEdge.apiNavImIm.key);
        expect(turnEdge.data.direction).toBe(EdgeConstants.EdgeDirection.TURN_RIGHT);
    });
    ...
    it("should have a u-turn edge", () => {
        ...
        expect(turnEdge.to).toBe(potentialEdge.apiNavImIm.key);
        expect(turnEdge.data.direction).toBe(EdgeConstants.EdgeDirection.TURN_U);
    });
...
describe("EdgeCalculator.computeTurnEdges", () => {
    ...
    it("should have a turn left edge with the smallest motion difference", () => {
        let motionChange: number =
            directions.turns[EdgeConstants.EdgeDirection.TURN_LEFT].motionChange;
